...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.ICE_MAINNET] = contractAddresses.ICE_MAINNET.FACTORY, _FACTORY_ADDRESS[exports.ChainId.ICE_ARCTIC] = contractAddresses.ICE_ARCTIC.FACTORY, _FACTORY_ADDRESS);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (chainId === undefined) chainId = exports.ChainId.ICE_MAINNET;
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, EverestPair.abi, provider).getReserves()).then(function (_ref) {
...
Currency.CURRENCY = (_Currency$CURRENCY = {}, _Currency$CURRENCY[exports.ChainId.ICE_ARCTIC] = /*#__PURE__*/new Currency(18, 'ICZ', 'ICZ'), _Currency$CURRENCY[exports.ChainId.ICE_MAINNET] = /*#__PURE__*/new Currency(18, 'ICZ', 'ICZ'), _Currency$CURRENCY);
...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  function Token(chainId, address, decimals, symbol, name) {
    ...
    _this.chainId = exports.ChainId.ICE_MAINNET;
...
var WICZ = (_WICZ = {}, _WICZ[exports.ChainId.ICE_ARCTIC] = /*#__PURE__*/new Token(exports.ChainId.ICE_ARCTIC, contractAddresses.ICE_ARCTIC.WICZ, 18, 'WICZ', 'Wrapped ICZ'), _WICZ[exports.ChainId.ICE_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.ICE_MAINNET, contractAddresses.ICE_MAINNET.WICZ, 18, 'WICZ', 'Wrapped ICZ'), _WICZ);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === CICZ[pairs[0].chainId] && pairs[0].involvesToken(WICZ[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === CICZ[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WICZ[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, chainId) {
    ...
    this.chainId = exports.ChainId.ICE_MAINNET;
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === CICZ[chainId] ? CurrencyAmount.ether(amounts[0].raw, chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === CICZ[chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, chainId) : amounts[amounts.length - 1];
...
exports.ICE_ARCTIC = ICE_ARCTIC;
exports.ICE_MAINNET = ICE_MAINNET;
